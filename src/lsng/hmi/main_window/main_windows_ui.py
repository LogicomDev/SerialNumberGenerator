...
"}")
        ...
        self.lbl_color.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_color, 6, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.sp_mac_left, 2, 1, 1, 1)
        ...
        self.lbl_po_number.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_po_number, 5, 0, 1, 1)
        ...
        self.lbl_prod_date.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_prod_date, 7, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.sp_week, 7, 1, 1, 1)
        ...
        self.lbl_mac_left.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_mac_left, 2, 0, 1, 1)
        ...
        self.label_2.setStyleSheet("color: rgb(107, 214, 0);")
...
"")
        ...
        self.gridLayout.addWidget(self.sp_imei_left, 2, 2, 1, 1)
        ...
        self.lbl_connect.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_connect, 0, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.sp_year, 7, 2, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.txt_color, 6, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.txt_user, 0, 1, 1, 2)
...
"")
        ...
        self.lbl_qty.setStyleSheet("color: rgb(107, 214, 0);")
        ...
        self.gridLayout.addWidget(self.lbl_qty, 9, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.sp_qty, 9, 1, 1, 2)
...
"")
        ...
        self.gridLayout.addWidget(self.txt_supplier, 3, 1, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.txt_model, 3, 2, 1, 1)
...
"}")
        ...
        self.prg_generation.setStyleSheet("<div class=\"w3-light-grey w3-round\">\n"
...
"</div>")
        ...
        self.verticalLayout.addWidget(self.prg_generation)
...
"}")
        ...
        self.lbl_logicom.setMaximumSize(QtCore.QSize(16777215, 100))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        ...
        self.gridLayout_6.addWidget(self.lbl_logicom, 1, 0, 1, 1)
